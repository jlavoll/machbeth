...
@export var lamp_lens_emission_energy: float = 12.0
...
@export var spotlight_energy: float = 35.0                  # VERY STRONG beam energy multiplier!
@export var spotlight_range_multiplier: float = 1.4         # Throws light 1.4x the lot size
@export var spotlight_cone_angle: float = 55.0              # Wide 55-degree floodlight cone
